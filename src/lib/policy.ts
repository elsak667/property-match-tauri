...
const ***REMOVED*** = (typeof import.meta !== 'undefined' && (import.meta as {env?: Record<string, string>}).env?.VITE_***REMOVED***) || "";
...
async function getTenantToken(): Promise<string> {
  if (!FEISHU_APP_ID || !***REMOVED***) {
    throw new Error("飞书凭证未配置，请设置 VITE_FEISHU_APP_ID 和 VITE_***REMOVED*** 环境变量");
  }
