...
export const MOCK_POLICIES: PolicyResult[] = [
  {
    ...
    area: "浦东新区", industry: "人工智能", subject: "企业", threshold: "需为国家高新技术企业", cap: "资金补贴",
  ...
  },
  {
    ...
    area: "浦东新区张江科学城", industry: "生物医药", subject: "企业/科研机构", threshold: "需在张江科学城内", cap: "综合支持",
  ...
  },
  {
    ...
    area: "浦东新区", industry: "集成电路", subject: "企业", threshold: "需规模以上工业企业", cap: "研发支持",
  ...
  },
  {
    ...
    area: "浦东新区", industry: "绿色低碳", subject: "企业", threshold: "需通过清洁生产审核", cap: "荣誉表彰",
  ...
  },
  {
    ...
    area: "浦东新区外高桥港区", industry: "航运贸易", subject: "企业", threshold: "需在外高桥港区有实际业务", cap: "综合支持",
  ...
  },
  {
    ...
    area: "浦东新区", industry: "智能制造", subject: "规模以上工业企业", threshold: "需具有智能制造能力", cap: "示范推广",
  ...
  },
  {
    ...
    area: "浦东新区", industry: "全部行业", subject: "企业/个人", threshold: "需符合人才认定条件", cap: "人才支持",
  ...
  },
  {
    ...
    area: "浦东新区", industry: "科技服务", subject: "中小企业", threshold: "需为科技型中小企业", cap: "研发支持",
...
export function filterPolicies(
  ...
  return policies.filter(p => {
    ...
    return matchQuery && matchIndustry && matchLocation && matchDept;
  });
}
